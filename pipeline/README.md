...
The full pipeline narrative lives in [`04-technical-architecture.md`](../docs/concept/04-technical-architecture.md) (OC-04). The locked technical decisions are in [`OC_TA.md`](../docs/adr/OC_TA.md) (**Stack**, **Constraints**).
...
Three tiers per [`AGENTS.md`  Testing strategy](../AGENTS.md):
...
For Python style, type hints, ruff settings, and commit format — read [`AGENTS.md`](../AGENTS.md). The short version:
